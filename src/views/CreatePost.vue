...
import { imgDocRef, newBlogPostDocRef } from "../middleware/bindings";
...
export default {
  ...
  methods: {
    ...
    ...mapActions(["watchBlogPosts", "addBlogPost"]),
        ...
        if (this.file) {
          ...
          docRef.put(this.file).on(
            ...
            async () => {
              ...
              const blogDocRef = newBlogPostDocRef();

              var payload = {
                blogDocRef: blogDocRef,
              ...
              await this.addBlogPost(payload);

              this.loading = false;

              this.$router.push({
                name: "ViewBlog",
                params: { blogid: blogDocRef.id },
              });
            }
          );
          return;
